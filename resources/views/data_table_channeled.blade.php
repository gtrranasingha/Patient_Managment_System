...
<main>
  ...
  <div class="col-md-12">
      ...
      <h2>Channeled Appoinments</h2>  
      <br> 
      <div class="col-md-12">
        <div class="text-center">
          <button class="btn btn-success">Total Income :Rs {{$tot}}</button>
          <button class="btn btn-success">Monthly Income :Rs {{$mic}}</button>
        </div>
      </div>
      ...
      <thead class="th">
        ...
        <tr>
          ...
          <th class="th-sm">Appoinment Number
          </th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/welcome/accepted_appointments/cancel_appointments/{{$data->id}}"><button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-3" title="Delete"><i class="far fa-trash-alt"></i></button></a>
            </td>
        </tr>
