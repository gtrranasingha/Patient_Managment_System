  ...
  <div class="col-md-12">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> {{$data->no}}</td>
          <td>
            <a href="/welcome/accept_appointments/{{$data->id}}"><button type="button" class="btn btn-blue btn-rounded btn-sm px-2 m-0 col-md-3" title="IN"><i class="far fa-out">IN</i></button></a>
            <a href="/welcome/cancel_appointments/{{$data->id}}"><button type="button" class="btn btn-danger btn-rounded btn-sm px-2 m-0 col-md-3" title="Cancle"><i class="far fa-trash-alt"></i></button></a>
            </td>
        </tr>
